...
class SlackAPI:
    ...
    def invoke(self, message: str, channel: str = None, pipeline_id: str = "N/A", variant: str = "N/A", **kwargs):
        ...
        try:
            response = self.client.chat_postMessage(channel=target_channel, text=message)
